...
print(f"      pushing sin²θ₁₂ back toward 0.303 (v7.1 scope).")
print()
...
print(f"      The ∞₃ Z₃-seesaw generates exactly this; required at v7.1 level.")
print()
...
print(f"      level; full threshold computation is v7.1 scope.")
print()
...
print(f"    A_v7.1 = {A_CKM_v7:.4f} × (1 + {f_self:.4f}) = {A_CKM_v7 * ratio:.4f}  (= PDG {CKM_A_PDG:.4f} ✓)")
...
print(f"    Scope: v7.1 (off-diagonal M_R + NuFIT global fit comparison).")
...
print("=" * 70)
print()
print(f"  {'Observable':<22} {'STUR v7.0':<14} {'PDG':<12} {'Dev':<8} {'v7.1 fix'}")
print(f"  {'-'*72}")
rows = [
