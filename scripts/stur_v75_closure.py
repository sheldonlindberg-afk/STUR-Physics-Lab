...
print(f"")
print(f"  DESI BAO DR1 (2024) → DR2 (2025):")
print(f"    DR1: w₀ = -0.727 ± 0.067, w_a = -1.05 (+0.31/-0.27)")
print(f"         (DESI + CMB + DESY5, 3.9σ tension with ΛCDM)")
print(f"    DR2: 2.8-4.2σ preference for evolving DE")
print(f"         Best fit: w₀ ~ -0.7, w_a ~ -1.0")
...
print(f"    DESI DR1+DESY5: w₀ = -0.727 ± 0.067, w_a = -1.05 (+0.31/-0.27)")
print(f"    Deviation: w₀ at {abs(w0_STUR - (-0.727)) / 0.067:.1f}σ, "
      f"w_a at {abs(wa_STUR - (-1.05)) / 0.31:.1f}σ from DESI")
print()

# JWST early galaxy tension
print(f"  JWST EARLY GALAXY TENSION (spectroscopically confirmed):")
print(f"    JADES-GS-z14-0: z = 14.18, M★ ~ 10⁸·⁶ M☉ (290 Myr after BB)")
print(f"      ALMA [OIII] 88μm detection at 6.67σ — NOT photometric")
print(f"    ZF-UDS-7329: >10¹¹ M☉ formed at z ~ 11 (already quiescent)")
print(f"      Baryon-to-DM fraction exceeds cosmic mean (physically impossible)")
print(f"    RUBIES-EGS-QG-1: ~10¹¹ M☉ at z = 4.9, all stars in 200 Myr burst")
print(f"")
print(f"    Quantitative tension:")
print(f"      Baryon conversion efficiency >80% needed vs <30% expected")
print(f"      Stellar mass density 20× excess at z~8, 1000× at z~9")
